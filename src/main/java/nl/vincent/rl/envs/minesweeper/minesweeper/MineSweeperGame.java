...
public class MineSweeperGame extends JFrame {
	...
	public MineSweeperGame(int size, int toughness) {
	...
	public void main(MineSweeperGame frame, int size) {
...
//	}
	...
	public int[][] getObservation() {
		int[][] observation = new int[mineLand.length][mineLand.length];
		for (int i = 0 ; i< mineLand.length; i ++) {
			for (int j = 0 ; j< mineLand.length; j++) {
				boolean isReveiled = revealed[i][j];
				int value;
				if (!isReveiled) {
					value = -1;
				} else {
	...
	public int buttonClicked(int x, int y) {
		int noRevealedBefore = noOfRevealed;
...
//	MineSweeperGame parent;
//
//	GameEngine(MineSweeperGame parent) {
//		this.parent = parent;
//	}
//
//	@Override
...
//	MineSweeperGame parent;
//
//	MyMouseListener(MineSweeperGame parent) {
//		this.parent = parent;
//	}
//
...
//	private Thread t;
//	private MineSweeperGame newGame;
//
//	timeThread(MineSweeperGame newGame) {
